...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendErrorMailImprime(String filename, LigneKbartImprime kbart, Exception e) {
        ...
        //  Création du mail
        String requestJson = mailToJSON(this.recipient, "[CONVERGENCE] Erreur lors de la création de la notice électronique à partir de l'imprimé " + kbart.getPpn(), body.toString());
        //  Envoi du message par mail
        sendMail(requestJson);
        log.info("L'email a été correctement envoyé.");
    }
