...
class BaconServiceTest {
    ...
    @BeforeEach
    void init() {
        ProviderPackage providerPackage0 = new ProviderPackage(new ProviderPackageId("test1", new GregorianCalendar(2023, Calendar.AUGUST, 1).getTime(), 1), 'N');
        ProviderPackage providerPackage1 = new ProviderPackage(new ProviderPackageId("test2", new GregorianCalendar(2023, Calendar.OCTOBER, 2).getTime(), 2), 'N');
        ProviderPackage providerPackage2 = new ProviderPackage(new ProviderPackageId("test3", new GregorianCalendar(2023, Calendar.SEPTEMBER, 28).getTime(), 3), 'N');
        ProviderPackage providerPackage3 = new ProviderPackage(new ProviderPackageId("test4", new GregorianCalendar(2023, Calendar.APRIL, 27).getTime(), 4), 'N');
        ProviderPackage providerPackage4 = new ProviderPackage(new ProviderPackageId("test5", new GregorianCalendar(2023, Calendar.NOVEMBER, 16).getTime(), 5), 'N');
    ...
    void testFindLastVersionOfPackage1() {
        ...
        Assertions.assertEquals("test3", providerPackage.getProviderPackageId().getPackageName());
        Assertions.assertEquals(3, providerPackage.getProviderPackageId().getProviderIdtProvider());
